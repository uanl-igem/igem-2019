...
def pend(z, t, K1cat, K1m, K2cat, K2m, K3cat, K3m, volo, volc, volb, j_m_V, j_m_P, j_m_C, j_m_M, j_b_Vo, j_b_Po, j_b_Co, j_b_Mo, j_b_Vi, j_b_Pi, j_b_Ci, j_b_Mi, Vo, Po, Co, Mo):
    ...
    dVbdt = (-j_b_Vi*(Vb-Vc)-j_b_Vo*(Vb-Vc))/volb-(K1cat*Eb*Vb)/(Vb + K1m) #Vanilic acid in BMC
    dPbdt = (-j_b_Pi*(Pb-Pc)-j_b_Po*(Pb-Pc))/volb+(K1cat*Eb*Vb)/(Vb + K1m)-(K2cat*EEb*Pb)/(Pb + K2m) #PCA in BMC
...
print("BMC- "+str(round(sol[400003, 6],13))+"mM")
print()
print("Muconic acid:")
print("Cell- "+str(round(sol[400003, 3],14))+"mM")
print("BMC- "+str(round(sol[400003, 7],12))+"mM")
print()
